...
import Message, { CONTENT_TYPE, MessageProps } from "../../components/message";
...
const Dashboard: FunctionComponent<DashboardProps> = () => {
  ...
  const handleChange = (
    ...
    if (e.target.type === "radio") setConType(e.target.value);
      ...
      if (e.target.type === "file") setMsg(e.target.files[0]);
              ...
              <div className="w-full h-1/2 p-2 flex gap-2">
                {conType == "TEXT" ? (
                  ...
                  <input
                    ...
                    type="file"
                    onChange={handleChange}
                    className="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base"
                  />
                )}
                <button
